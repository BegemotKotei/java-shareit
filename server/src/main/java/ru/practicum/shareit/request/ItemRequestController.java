...
public class ItemRequestController {
    ...
    public ResponseEntity<List<AnswerItemRequestDto>> getUsersItemRequests(@RequestHeader("X-Sharer-User-Id") Long userId) {
        ...
        return ResponseEntity.ok().body(itemRequestService.getUsersItemRequests(userId));
    }
    ...
    public ResponseEntity<List<AnswerItemRequestDto>> getItemRequests(
        ...
        return ResponseEntity.ok().body(itemRequestService.getItemRequests(userId, PageRequest.of(from / size, size)));
    }
